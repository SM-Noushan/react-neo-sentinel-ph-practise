...
const RightColumn = () => {
  const headingCSS = "text-xl text-dark-02 font-semibold";
  const loginWithBtnCSS = "btn w-full outline outline-1  text-base";
  const instagramGradientID = "instagramGradient";
  return (
    <>
      <div className="space-y-6">
        <h2 className={headingCSS}>Login With</h2>
        <div className="space-y-3">
          <button
            className={`${loginWithBtnCSS} outline-yellow-500 text-yellow-500`}
          >
            <FaGoogle />
            Login With Google
          </button>
      ...
      <div className="my-12 space-y-6">
        <h2 className={headingCSS}>Find Us On</h2>
      ...
      <div className="my-12 space-y-6 bg-dark-07 rounded-md">
        <h2 className={`pt-8 pl-2 ${headingCSS}`}>Q-Zone</h2>
